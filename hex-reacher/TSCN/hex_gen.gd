...
@export var enemy1XArr : Array[int] = []
@export var enemy1YArr : Array[int] = []

@export var enemy2Arr : Array[Node2D] = []
@export var enemy2XArr : Array[int] = []
@export var enemy2YArr : Array[int] = []

@export var enemy3Arr : Array[Node2D] = []
@export var enemy3XArr : Array[int] = []
@export var enemy3YArr : Array[int] = []
...
@export var enemy1MaxNum : int = 0
@export var enemy1Count : int = 0
@export var enemy1Div : int = 0

@export var enemy2MaxNum : int = 0
@export var enemy2Count : int = 0
@export var enemy2Div : int = 0

@export var enemy3MaxNum : int = 0
@export var enemy3Count : int = 0
